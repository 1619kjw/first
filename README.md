...
* 스테이징 : 깃허브에 작업 업로드 전 파일을 대기시키는 장소
...
# html&meta 속성의 뜻
## html의 속성
* `<html lang="ko">` html 문서의 언어는 한국어다
## meta의 속성
* `<meta charset="utf-8">` 문자열을 유닛코드로 다국어 지원하겠다
* `<meta name="description" content="">` ""라는 요약설명을 하겠다
* `<meta name="keywords" content="">` ""라는 키워드를 작성하겠다